 ...
 */
public class IB1IC_facor_threshold2 extends Classifier implements UpdateableClassifier, TechnicalInformationHandler {
...
/*		for (int k = 0; k < idnumber; k++) {
	...
	public static void main(String[] argv) throws Exception {
		 ...
		 //String filepath ="F:/ϵͳ����/weka-src/data/56Data/spilce.arff";
