 ...
 */
public class IBk_CopyAttr extends Classifier implements OptionHandler, UpdateableClassifier, WeightedInstancesHandler,
	...
	public static void main(String[] argv) throws Exception {
		runClassifier(new IBk_CopyAttr(), argv);
