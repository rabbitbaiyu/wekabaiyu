 ...
 */
public class IBk_Copy_knn1000 extends Classifier implements OptionHandler, UpdateableClassifier, WeightedInstancesHandler,
	...
	/**
	 * Whether the value of k selected by cross validation has been invalidated
	 * by a change in the training instances.
	 */
	protected boolean m_kNNValid;

	/**
	 * The maximum number of training instances allowed. When this limit is
	 * reached, old training instances are removed, so the training data is
	 * "windowed". Set to 0 for unlimited numbers of instances.
	 */
	...
	/**
	 * Whether to minimise mean squared error rather than mean absolute error
	 * when cross-validating on numeric prediction tasks.
	 */
	 ...
	 * addition of new instances above this value will result in old instances
	 * being removed. A value of 0 signifies no limit to the number of training
	 * instances.
	 *
	...
	/**
	 * Gets whether the mean squared error is used rather than mean absolute
	 * error when doing cross-validation.
	 *
	 * @return true if so.
	 */
	...
	/**
	 * Sets whether the mean squared error is used rather than mean absolute
	 * error when doing cross-validation.
	 *
	...
	/**
	 * Gets whether hold-one-out cross-validation will be used to select the
	 * best k value.
	 *
	...
	/**
	 * Sets whether hold-one-out cross-validation will be used to select the
	 * best k value.
	 *
	 ...
	 * 
	 * @return the number of training instances the classifier is currently
	 *         using
	 */
	...
	/**
	 * Returns the value of the named measure from the neighbour search
	...
	/**
	 * Select the best value for k by hold-one-out cross-validation. If the
	 * class attribute is nominal, classification error is minimised. If the
	 * class attribute is numeric, mean absolute error is minimised
	 */
	...
	public static void main(String[] argv) throws Exception {
		runClassifier(new IBk_Copy_knn1000(), argv);
