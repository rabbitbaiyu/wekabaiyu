 ...
 */
public class IB1KIC2 extends Classifier implements UpdateableClassifier, TechnicalInformationHandler {
...
/*		for (int k = 0; k < similar.length; k++) {
		...
		int closest = (int)(similarity*percentage);
...
/*	private void updateMinMax(Instance instance) {
	...
	public static void main(String[] argv) throws Exception {
		 //runClassifier(new IB1KIC2(), argv);

		
		 //String filepath ="F:/系统备份/weka-src/data/56Data/iris.arff";
		 String filepath ="F:/系统备份/weka-src/data/weather.nominal.arff";
		 IB1KIC2 ib2 = new IB1KIC2(); 
		 ib2.setPercentage(0.7);
		 double per = ib2.getPercentage();
		 System.out.println("per	"+per); // System.out.println(ins);
