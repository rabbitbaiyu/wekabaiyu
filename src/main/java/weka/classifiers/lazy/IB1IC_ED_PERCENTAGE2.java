 ...
 */
public class IB1IC_ED_PERCENTAGE2 extends Classifier implements UpdateableClassifier, TechnicalInformationHandler {
...
Instances m_Train1 = new Instances(instances, 0, instances.numInstances());
	    ...
	    ibkic.setAttrfactor(18);
	    double ar = fitness(test);
...
/*	    for(int k=0;k<fit.length;k++){
	...
	public static void main(String[] argv) throws Exception {
		 ...
		 IB1IC_ED_PERCENTAGE2 ib2 = new IB1IC_ED_PERCENTAGE2(); 
